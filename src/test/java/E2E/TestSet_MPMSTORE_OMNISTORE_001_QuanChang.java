...
public class TestSet_MPMSTORE_OMNISTORE_001_QuanChang {
    ...
    private String tcKey = "OMNISTORENormalActivity";
    ...
    public void test003_创建全场券() throws InterruptedException {
        boolean newCouponResult = createActivity.createOMNIStoreNormalActivity(driver, "[Auto]全O核", "noStack",15,"105","5");
