...
public class TestSet_H5_MPMSTORE_009_HeiMingDan {
    ...
    public void test005_活动页黑名单页面获取() throws InterruptedException {
    ...
    @Test(dependsOnMethods = {"test005_活动页黑名单页面获取"}, enabled = true)
    ...
    public void test014_创建活动页黑名单全场券() throws InterruptedException {
        boolean newCouponResult = createActivity.createH5BlackModelListNormalActivity(driver,4,"105","10");
        assertEquals(newCouponResult, true, "BackOffice创建黑名单活动失败");
    }

    @Test(dependsOnMethods = {"test014_创建活动页黑名单全场券"}, enabled = true)
    public void test015_活动页黑名单全场券页面获取() throws InterruptedException {
        activityInfo = validateActivity.validateActivity(driver,"normal","noStack");
    ...
    @Test(dependsOnMethods = {"test015_活动页黑名单全场券页面获取"}, enabled = true)
    public void test025_活动页全场券页面获取() throws InterruptedException {
        activityInfo = validateActivity.UpdateActivity(driver, activityInfo, "normal", "noStack",200000);
        assertEquals(activityInfo.get("Active Status"), "Take effect", "活动状态变更错误");
    }

    @Test(dependsOnMethods = {"test025_活动页全场券页面获取"}, enabled = true)
