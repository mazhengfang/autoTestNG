...
public class TestSet_MPMSTORE_MPMSTORE_006_ShangPin {
    ...
    private String tcKey = "ProductActivity";
    ...
    public void test003_创建商品券() throws InterruptedException {
        boolean newCouponResult = createActivity.createProductActivity(driver,"[Auto]单品券","noStack",15,"105","5");
        assertEquals(newCouponResult, true, "BackOffice创建单品券失败");
    }

    //
    @Test(dependsOnMethods = {"test003_创建商品券"}, enabled = true)
    public void test004_商品券页面获取() throws InterruptedException {
        activityInfo = validateActivity.validateActivity(driver,"product","noStack");
    }

    @Test(dependsOnMethods = {"test004_商品券页面获取"}, enabled = true)
    public void test005_校验商品券() {
...
//        assertEquals(activityInfo.get("Stacking Checked"), "false", "Coupon Stacking Status is not correct");
    ...
    @Test(dataProvider = "test005_校验商品券", dependsOnMethods = {"test005_校验商品券"}, enabled = true)
    public void test006_校验商品券(backOfficeTestCase tc) {
    ...
    @DataProvider(name = "test005_校验商品券")
    private Object[][] test005_校验商品券_TestData() {
    ...
    @Test(dependsOnMethods = {"test006_校验商品券"}, enabled = true)
    ...
    public void test008_userAvailableCoupon() {
        httpResponse rs = userAvailableCoupon.userAvailableCoupon(Env, facadePromoHost, "MPMSTORE", bodyNumber2,personNumber);
        int rsCode = rs.getCode();
    ...
    public void test009_商品券页面获取() throws InterruptedException {
    ...
    @Test(dependsOnMethods = {"test009_商品券页面获取"}, enabled = true)
    ...
    public void test012_loggedUserReceiveCoupon() throws InterruptedException {
        ...
        System.out.println("Code: " +couponCodeByStockID);
...
//        assertEquals(dbRecord.getString("status"), "FROZEN", "Redeem Coupon接口返回报错");
    ...
    public void test021_userAvailableCoupon() throws InterruptedException {
        ...
        assertEquals(couponCodeStatus, true, "核券后优惠券状态异常，期望结果是UNCLAIMED");
    }
...
//        assertEquals(dbRecord.getString("status"), "EXCHANGED", "Refund Coupon接口返回报错");
    ...
    public void test029_商品券活动关闭() throws InterruptedException {
    ...
    @Test(dependsOnMethods = {"test029_商品券活动关闭"}, enabled = true)
