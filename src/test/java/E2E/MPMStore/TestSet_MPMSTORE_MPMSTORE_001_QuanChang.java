...
public class TestSet_MPMSTORE_MPMSTORE_001_QuanChang {
    ...
    public void test003_创建全场券() throws InterruptedException {
        boolean newCouponResult = createActivity.createNormalActivity(driver, "[Auto]全场券", "noStack",15,"105","5");
    ...
    @Test(dependsOnMethods = {"test006_校验全场券"}, enabled = true)
