...
public class TestSet_MPMSTORE_MPMSTORE_001_QuanChang_tmp {
    ...
    private String tcKey = "NormalActivity";
    ...
    String stockID ="2312200061100002" ;
...
//    }
    ...
    public void test012_loggedUserReceiveCoupon() throws InterruptedException {
        httpResponse rs = loggedUserReceiveCoupon.loggedUserReceiveCoupon_StockID(Env, facadePromoHost,"MPMSTORE", personNumber, stockID);
        int rsCode = rs.getCode();
        JSONArray rsData = rs.getBody(JSONObject.class).getJSONArray("data");
...
//        assertEquals(dbRecord.getString("status"), "EXCHANGED", "Refund Coupon接口返回报错");
    ...
    public void test029_全场券活动关闭() throws InterruptedException {
        String activityStatus = validateActivity.closeActivity(driver, stockID);
...
//    @Test(dependsOnMethods = {"test026_loggedUserReceiveCoupon"}, enabled = true)
    public void test027_queryUserCoupon() throws InterruptedException {
        ...
        boolean couponCodeStatus = crossFunctions.couponCodeValidation(couponList, stockID, couponCodeByStockID,"EXPIRED");
