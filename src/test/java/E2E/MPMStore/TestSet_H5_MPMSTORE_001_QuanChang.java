...
public class TestSet_H5_MPMSTORE_001_QuanChang {
    ...
    private String tcKey = "H5NormalActivity";
...
//    @BeforeSuite
    ...
    public void test003_创建活动页全场券() throws InterruptedException {
        boolean newCouponResult = createActivity.createH5NormalActivity(driver,"[Auto]H5全", "noStack",15,"105","5");
    ...
    @Test(dataProvider = "test005_校验活动页全场券", dependsOnMethods = {"test005_校验活动页全场券"}, enabled = true)
    public void test006_校验活动页全场券(backOfficeTestCase tc) {
    ...
    @DataProvider(name = "test005_校验活动页全场券")
    private Object[][] test005_校验活动页全场券_TestData() {
    ...
    @Test(dependsOnMethods = {"test006_校验活动页全场券"}, enabled = true)
    ...
    public void test011_userAvailableCoupon() throws InterruptedException {
        ...
        assertEquals(couponNotEffective, false, "生效活动在PDP页面接口展示活动数据，期望结果不展示");
    }
    ...
    public void test016_applyPromotionPlans() throws Exception {
        ...
        System.out.println(orderIDTicket);
...
//        assertEquals(dbRecord.getString("status"), "FROZEN", "Redeem Coupon接口返回报错");
    ...
    public void test017_promotionDetails_002(testCaseTemplateOne tcOne) {
        ...
        System.out.println("Key2: " + sKey+" actualValue: "+ actData + " expectedValue: " + expData);
        ...
        for (Object actData : actOrderItemPromos) {
            ...
            for (Object expData : expOrderItemPromos) {
                ...
                if (actSkuID.equals(expSkuID)) {
                    ...
                    System.out.println("Key3: " + sKey+" actualValue: "+ actItemData + " expectedValue" + expItemData);
...
//        assertEquals(dbRecord.getString("status"), "EXCHANGED", "Refund Coupon接口返回报错");
    ...
    public void test029_活动页全场券活动关闭() throws InterruptedException {
    ...
    @Test(dependsOnMethods = {"test029_活动页全场券活动关闭"}, enabled = true)
