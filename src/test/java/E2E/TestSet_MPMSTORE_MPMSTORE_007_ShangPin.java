...
public class TestSet_MPMSTORE_MPMSTORE_007_ShangPin {
    ...
    public void test003_创建商品券() throws InterruptedException {
        boolean newCouponResult = createActivity.createProductActivity(driver,"[Auto]单品券","noStack",5,"110","10");
    ...
    public void test005_商品券页面获取() throws InterruptedException {
    ...
    @Test(dependsOnMethods = {"test005_商品券页面获取"}, enabled = true)
    ...
    public void test014_创建商品券() throws InterruptedException {
        boolean newCouponResult = createActivity.createProductActivity(driver,"[Auto]单品券","noStack",3,"110","20");
        assertEquals(newCouponResult, true, "BackOffice创建单品券失败");
    }

    //
    @Test(dependsOnMethods = {"test014_创建商品券"}, enabled = true)
    public void test015_商品券页面获取() throws InterruptedException {
        activityInfo = validateActivity.validateActivity(driver,"product","noStack");
    }

    @Test(dependsOnMethods = {"test015_商品券页面获取"}, enabled = true)
    public void test016_商品券页面获取() throws InterruptedException {
        activityInfo = validateActivity.UpdateActivity(driver, activityInfo, "normal", "noStack",120000);
        assertEquals(activityInfo.get("Active Status"), "Take effect", "活动状态变更错误");
    }

    @Test(dependsOnMethods = {"test016_商品券页面获取"}, enabled = true)
