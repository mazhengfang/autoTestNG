...
@Slf4j
public class OfflineCoupon_DistributeChannelH5_UseChannelWebPos {
    ...
    private String ReqByKey= "createDistChlH5_PPage-UseWebPos";
...
//                    System.out.println("Key4 " + sKey + ":" + actItemData + ":" + expItemData);
   ...
   @AfterTest
    public void report() {
        writeExl.writeExcel("Oln_H5_WebPos ",config.testRltData,8,config.filePath);
    }
