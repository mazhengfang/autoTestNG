...
public class OfflineCoupon_DistributeChannelPromotionPage_UseChannelWebPos {
    ...
    private String ReqBodyPath ="src/main/resources/ConfigInfo/BackOffice/createOnlineMerchantCoupon/requestBody.json";
     private String ReqByKey= "createDistChlH5_PPage-UseWebPos-2";
    ...
    private OfflineMerchantCoupon OfflineMerchantCoupon;
    ...
    public void TC001_createStock(){
        OfflineMerchantCoupon = new OfflineMerchantCoupon();
        httpResponse createResponse = OfflineMerchantCoupon.create(config.URL,config.authorization,rhKey,rhPath,ReqByKey,ReqBodyPath);
    ...
    public void TC002_queryStockID() throws Exception {
        ...
        config.rpt.testResultData(config.stepName,config.stepDescription,styType," ",config.actRlt,config.testData,config.testRltData);
    }
    ...
    public void TC004_queryFlowID() throws Exception {
        ...
        config.rpt.testResultData(config.stepName,config.stepDescription,styType,config.actRlt,config.actRlt,config.testData,config.testRltData);
    }
    ...
    public void TC007_queryManagerAuditApproveStatus() throws Exception {
        ...
        config.rpt.testResultData(config.stepName,config.stepDescription,styType,config.expRlt,config.actRlt," ",config.testRltData);
    ...
    public void test017_loggedUserReceiveCoupon() throws InterruptedException {
        ...
        config.rpt.testResultData(config.stepName,config.stepDescription,styType,config.expRlt,config.actRlt,couponCodeByStockID,config.testRltData);
    ...
    public void test018_queryUserCoupon() throws InterruptedException {
        ...
        config.rpt.testResultData(config.stepName,config.stepDescription,styType,config.expRlt,config.actRlt,"AVAILABLE",config.testRltData);
...
//        JSONArray couponsList = rsData.getJSONArray("coupons");
        ...
        config.rpt.testResultData(config.stepName,config.stepDescription,styType,config.expRlt,config.actRlt,planIndex,config.testRltData);
    ...
    public void test023_queryUserCoupon() throws InterruptedException {
        ...
        config.expRlt = String.valueOf(true);
        config.actRlt = String.valueOf(couponCodeStatus);
        config.rpt.testResultData(config.stepName,config.stepDescription,styType,config.expRlt,config.actRlt, "USED" ,config.testRltData);
    ...
    public void test025_promotionDetails_001() throws InterruptedException {
        ...
        config.actRlt = String.valueOf(rsCode);
        config.rpt.testResultData(config.stepName,config.stepDescription,styType,config.expRlt,config.actRlt, config.actRlt ,config.testRltData);
...
//                    System.out.println("Key4 " + sKey + ":" + actItemData + ":" + expItemData);
    ...
    @Test(dependsOnMethods = "TC038_H5DistributeChannel")
    ...
    @AfterTest
    public void report() {
        writeExl.writeExcel("Oln_PP_WebPos ",config.testRltData,8,config.filePath);
    }
