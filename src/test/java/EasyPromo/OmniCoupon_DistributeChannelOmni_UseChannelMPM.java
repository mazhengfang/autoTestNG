...
@Slf4j
public class OmniCoupon_DistributeChannelOmni_UseChannelMPM {
    ...
    private String ReqByKey= "createDistChlOmni-UseOmniMPMStore";
...
//                    System.out.println("Key4 " + sKey + ":" + actItemData + ":" + expItemData);
    ...
    @AfterTest
    public void report() {
        writeExl.writeExcel("Omni_Omni_MPMStore",config.testRltData,8,config.filePath);
    }
