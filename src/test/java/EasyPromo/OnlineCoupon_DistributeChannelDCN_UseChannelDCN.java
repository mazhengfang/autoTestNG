...
@Slf4j
public class OnlineCoupon_DistributeChannelDCN_UseChannelDCN {
    ...
    private String ReqByKey=  "createDistChlDCN_PPage-UseMPM";
    ...
    private String DCNBodyNumber="5";
    ...
    public void TC011_loggedUserReceiveCoupon() throws InterruptedException {
        httpResponse rs = loggedUserReceiveCoupon.loggedUserReceiveCoupon_StockID(config.env,  config.facadeURL,DCNclientName, config.personNumber, stockID);
        int rsCode = rs.getCode();
        ...
        assertEquals(titleInfo,config.expRlt, "会员领券返回title异常");
    }
    ...
    @Test(dependsOnMethods = "test015_MPMQueryUserCoupon")
    ...
    @Test(dependsOnMethods = {"test035_DCNQueryUserCoupon"}, enabled = true)
    public void test016_MPMUserAvailableCoupon() throws InterruptedException {
        ...
        boolean couponNotEffective = crossFunctions.couponNotEffective(rsData, stockID);
        config.stepName = Thread.currentThread().getStackTrace()[1].getMethodName();
        config.stepDescription = "<Facade>校验生效活动在userAvailableCoupon接口不展示";
        config.expRlt = "true";
        config.actRlt = String.valueOf(couponNotEffective);
        config.testRltData = config.rpt.testResultData(config.stepName,config.stepDescription,styType,config.expRlt,config.actRlt," ",config.testRltData);
    ...
    @Test(dependsOnMethods = {"test016_MPMUserAvailableCoupon"}, enabled = true)
    ...
    @Test(dependsOnMethods = {"test036_DCNUserAvailableCoupon"}, enabled = true)
    ...
    @Test(dependsOnMethods = {"test018_MPMQueryUserCoupon"}, enabled = true)
    ...
    @Test(dependsOnMethods = {"test037_DCNQueryUserCoupon"}, enabled = true)
    ...
    @Test(dependsOnMethods = {"test019_MPMUserAvailableCoupon"}, enabled = true)
    ...
    @Test(dependsOnMethods = {"test038_DCNUserAvailableCoupon"}, enabled = true)
    public void test020_plans() throws InterruptedException {
        httpResponse rs = plans.plans(config.env, config.URL, DCNBodyNumber,config.personNumber);
        int rsCode = rs.getCode();
...
//        JSONArray couponsList = rsData.getJSONArray("coupons");
    ...
    public void test021_repricing() throws InterruptedException {
        httpResponse rs = repricing.repricing(config.URL, planIndex, DCNBodyNumber);
        int rsCode = rs.getCode();
    ...
    public void test022_applyPromotionPlans() throws Exception {
        httpResponse rs = applyPromotionPlans.applyPromotionPlans(config.URL, mirrorCode, DCNBodyNumber);
        int rsCode = rs.getCode();
    ...
    @Test(dependsOnMethods = {"test023_MPMQueryUserCoupon"}, enabled = true)
    ...
    @Test(dependsOnMethods = {"test039_DCNQueryUserCoupon"}, enabled = true)
    ...
    @Test(dependsOnMethods = {"test024_MPMUserAvailableCoupon"}, enabled = true)
    ...
    @Test(dependsOnMethods = {"test040_DCNUserAvailableCoupon"}, enabled = true)
    public void test025_promotionDetails_001() throws InterruptedException {
        httpResponse rs = promotionDetails.promotionDetails(config.URL, orderID, DCNBodyNumber);
        int rsCode = rs.getCode();
        config.stepName = Thread.currentThread().getStackTrace()[1].getMethodName();
...
//                    System.out.println("Key4 " + sKey + ":" + actItemData + ":" + expItemData);
    ...
    public void test026_redeemCoupon() throws Exception {
        httpResponse rs = redeemCoupon.redeemCoupon(config.URL, orderID, DCNBodyNumber);
        int rsCode = rs.getCode();
    ...
    public void test027_refundCoupon() throws Exception {
        httpResponse rs = refundCoupon.refundCoupon(config.URL, orderID, DCNBodyNumber);
        int rsCode = rs.getCode();
    ...
    @Test(dependsOnMethods = {"test028_MPMQueryUserCoupon"}, enabled = true)
    ...
    @Test(dependsOnMethods = {"test041_DCNQueryUserCoupon"}, enabled = true)
    ...
    @Test(dependsOnMethods = {"test029_MPMUserAvailableCoupon"}, enabled = true)
    ...
    @Test(dependsOnMethods = {"test042_DCNUserAvailableCoupon"}, enabled = true)
    ...
    public void test032_MPMUserAvailableCoupon() {
        ...
        boolean couponNotEffective = crossFunctions.couponNotEffective(rsData, stockID);
        config.stepName = Thread.currentThread().getStackTrace()[1].getMethodName();
        config.stepDescription = "<Facade>校验关闭后的活动在userAvailableCoupon接口不展示";
        config.expRlt = "true";
        config.actRlt = String.valueOf(couponNotEffective);
        config.testRltData = config.rpt.testResultData(config.stepName,config.stepDescription,styType,config.expRlt,config.actRlt," ",config.testRltData);
        assertEquals(couponNotEffective, true, "关闭后的活动在PDP页面接口展示活动数据，期望结果不展示");
    }

    @Test(dependsOnMethods = {"test032_MPMUserAvailableCoupon"}, enabled = true)
    ...
    @AfterSuite
    public void report() {
    writeExl.writeExcel("Oln_DCN_DCN ",config.testRltData,8,config.filePath);
    }
