...
//
//public class TestSet_MPMSTORE_005_D {
//    WebDriver driver;
...
//    private String tcKey = "DesignatedUsersProductActivity";
//    private HashMap<String, String> activityInfo;
//    private flowFunction flowBaseAPICommon;
...
//        boolean newCouponResult = createActivity.createDesignatedUserProductTypeActivity(driver,60,"105","5");
...
//    }
//
//    @Test(dataProvider = "test006_校验定向单品券_Data", dependsOnMethods = {"test005_校验定向单品券"}, enabled = true)
//    public void test006_校验定向单品券(backOfficeTestCase tc) {
...
//    }
//
//    @DataProvider(name = "test006_校验定向单品券_Data")
//    private Object[][] test006_校验定向单品券_TestData() {
...
//    }
//
//    @Test(dependsOnMethods = {"test006_校验定向单品券"}, enabled = true)
...
//
////        couponList = queryUserCoupon.couponList(rs, Env, facadePromoHost,personNumber,"AVAILABLE");
...
//        assertEquals(titleInfo, "批次无效或暂未开始", "指定会员领券返回title异常");
//    }
//
...
//        assertEquals(rsCode, 200, "查询用户接口返回报错");
//
//        couponList = queryUserCoupon.couponList(rs, Env, facadePromoHost,nonpersonPhone,"AVAILABLE");
//        boolean couponNotEffective = crossFunctions.couponNotEffective(couponList, activityInfo.get("StockID"));
//        assertEquals(couponNotEffective, true, "未生效活动在非指定用户的优惠券接口展示活动数据，期望结果不展示");
//    }
//
//
...
//        httpResponse rs = loggedUserReceiveCoupon.loggedUserReceiveCoupon_StockID(Env, facadePromoHost, nonpersonPhone, activityInfo.get("StockID"));
//        int rsCode = rs.getCode();
//        String titleInfo = rs.getBody(JSONObject.class).getString("title");
//        assertEquals(rsCode, 400, "会员领券返回code异常");
//        assertEquals(titleInfo, "批次无效或暂未开始", "非指定会员领券返回title异常");
//    }
//
...
//        assertEquals(couponNotEffective, true, "生效活动，在指定用户的优惠券接口不展示活动数据，期望结果展示");
//    }
//
...
//        httpResponse rs = userAvailableCoupon.userAvailableCoupon(Env, facadePromoHost, "2",personNumber);
//        int rsCode = rs.getCode();
//        assertEquals(rsCode, 200, "用户优惠券接口返回报错");
//
//        JSONArray rsData = rs.getBody(JSONObject.class).getJSONArray("data");
...
//        couponList = queryUserCoupon.couponList(rs, Env, facadePromoHost,nonpersonPhone,"AVAILABLE");
//        boolean couponNotEffective = crossFunctions.couponEffective(couponList, activityInfo.get("StockID"));
//        assertEquals(couponNotEffective, false, "生效活动，在非指定用户的优惠券接口展示活动数据，期望结果不展示");
//    }
//
...
//        System.out.println(couponCodeByStockID);
//    }
//
...
//        couponList = queryUserCoupon.couponList(rs, Env, facadePromoHost,personNumber,"AVAILABLE");
//        boolean couponNotEffective = crossFunctions.couponEffective(couponList, activityInfo.get("StockID"));
//        assertEquals(couponNotEffective, true, "领券后，活动在指定用户的优惠券接口不展示活动数据，期望结果展示");
//    }
//
//    @Test(dependsOnMethods = {"test018_queryDesignatedUserCoupon"}, enabled = true)
//    public void test029_queryNonDesignatedUserCoupon() throws InterruptedException {
//        sleep(10000);
//        JSONArray couponList;
//        httpResponse rs = queryUserCoupon.queryDesignatedUserCoupon(Env, facadePromoHost, "AVAILABLE", "ALL", 1, 5,true,nonpersonPhone);
//        int rsCode = rs.getCode();
...
//        couponList = queryUserCoupon.couponList(rs, Env, facadePromoHost,nonpersonPhone,"AVAILABLE");
//        boolean couponNotEffective = crossFunctions.couponEffective(couponList, activityInfo.get("StockID"));
//        assertEquals(couponNotEffective, false, "领券后，活动在非指定用户的优惠券接口展示活动数据，期望结果不展示");
//    }
//
//    @Test(dependsOnMethods = {"test029_queryNonDesignatedUserCoupon"}, enabled = true)
...
//        couponList = queryUserCoupon.couponList(rs, Env, facadePromoHost,personNumber,"USED");
...
//                    String actItemData = ((JSONObject) actData).getString(sKey);
//                    String expItemData = ((JSONObject) expData).getString(sKey);
//                    System.out.println(actItemData + ":" + expItemData);
...
//        int rsCode = rs.getCode();
//        assertEquals(rsCode, 200, "查询用户领券接口返回报错");
//        couponList = queryUserCoupon.couponList(rs, Env, facadePromoHost,personNumber,"ALL");
