...
public class LiveRoomProductActivity_TestSet001 {
    private String tcPath = "src/main/resources/ConfigInfo/TestCase/backOfficeTestCaseData.json";
    private String tcKey = "LiveRoomProductActivity";
    ...
    public void test003_创建直播券() throws InterruptedException {
        boolean newCouponResult = createActivity.createLiveRoomProductActivity(driver,"noStack","[Auto]直播单",15,"105","5");
