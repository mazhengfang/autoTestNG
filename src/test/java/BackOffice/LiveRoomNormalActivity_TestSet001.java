...
public class LiveRoomNormalActivity_TestSet001 {
    private String tcPath = "src/main/resources/ConfigInfo/TestCase/backOfficeTestCaseData.json";
    private String tcKey = "LiveRoomNormalActivity";
    ...
    public void test003_创建直播券() throws InterruptedException {
        boolean newCouponResult = createActivity.createLiveRoomNormalActivity(driver,"[Auto]直播全","noStack",15,"105","5");
