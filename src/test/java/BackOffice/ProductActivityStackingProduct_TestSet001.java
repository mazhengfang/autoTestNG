...
public class ProductActivityStackingProduct_TestSet001 {
    WebDriver driver;
    ...
    private String tcKey = "ProductActivityStackingProduct";
    public HashMap<String, String> activityInfo;
    ...
    public void test003_创建单品券() throws InterruptedException {
        boolean newCouponResult = createActivity.createProductActivity(driver,"[Auto]单叠单","product",15,"105","5");
        assertEquals(newCouponResult, true, "BackOffice创建单品券失败");
    }

    //
    @Test(dependsOnMethods = {"test003_创建单品券"}, enabled = true)
    public void test004_单品券页面获取() throws InterruptedException {
        activityInfo = validateActivity.validateActivity(driver,"product","product");
    }

    @Test(dependsOnMethods = {"test004_单品券页面获取"}, enabled = true)
    public void test005_校验单品券() {
    ...
    @Test(dataProvider = "test005_校验单品券", dependsOnMethods = {"test004_单品券页面获取"}, enabled = true)
    public void test006_校验单品券(backOfficeTestCase tc) {
    ...
    @DataProvider(name = "test005_校验单品券")
    private Object[][] test005_校验单品券_TestData() {
