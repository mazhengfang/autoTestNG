...
public class LiveRoomNormalActivityStackingProduct_TestSet001 {
    private String tcPath = "src/main/resources/ConfigInfo/TestCase/backOfficeTestCaseData.json";
    private String tcKey = "LiveRoomNormalActivityStackingProduct";
    ...
    public void test003_创建直播券() throws InterruptedException {
        boolean newCouponResult = createActivity.createLiveRoomNormalActivity(driver,"[Auto]直全叠","product",15,"105","5");
